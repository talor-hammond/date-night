...
var Home = function Home(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_Form2.default, { updateState: props.updateState })
    );
};
...
var Form = function (_Component) {
    ...
    _createClass(Form, [{
        ...
        key: 'getResults',
        value: function getResults(nameOne, nameTwo, food, cuisine, diet) {
            var _this2 = this;
            ...
            this.state.menu = {
                ...
                var _returns = _slicedToArray(returns, 3),
                    entree = _returns[0],
                    main = _returns[1],
                    dessert = _returns[2];
...
function getEntreeBy(cuisine, diet) {
  ...
  if (diet) {
    return _superagent2.default.get("https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?cuisine=" + cuisine + "&diet=" + diet + "&limitLicense=false&type=appetizer&minCalories=500&offset=0&number=100").set({ "X-Mashape-Key": mashapeKey, "X-Mashape-Host": mashapeHost }) // setting header w object: '.header(s)'
    .then(function (res) {
      var entrees = res.body.results;
      var entree = entrees[Math.floor(Math.random() * entrees.length)];
    ...
    return _superagent2.default.get("https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?cuisine=" + cuisine + "&limitLicense=false&type=appetizer&minCalories=500&offset=0&number=100").set({ "X-Mashape-Key": mashapeKey, "X-Mashape-Host": mashapeHost }) // setting header w object: '.header(s)'
    .then(function (res) {
      var entrees = res.body.results;
...
function getMainBy(food, cuisine, diet) {
  ...
  if (diet) {
    ...
    return _superagent2.default.get("https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?query=" + food + "&cuisine=" + cuisine + "&limitLicense=false&type=main+course&minCalories=700&offset=0&number=100").set({ "X-Mashape-Key": mashapeKey, "X-Mashape-Host": mashapeHost }) // setting header w object: '.header(s)'
    .then(function (res) {
      var mains = res.body.results;
...
var Results = function (_Component) {
    ...
    function Results(props) {
        ...
        _this.goToTop = _this.goToTop.bind(_this);
        return _this;
    }
    ...
    _createClass(Results, [{
        ...
        value: function goToRecipes() {
            ...
            if (!this.state.recipePicked) {
                ...
                this.setState({ // causing a re-render...
                    ...
                    console.log('Callback firing, ' + _this2.state.recipePicked);
                    _this2.handleScrollToElement();
                });
                console.log(this.state.recipePicked);
            } else {
                // when recipes have been closed...
                console.log(this.state.recipePicked);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _react2.default.Fragment,
                null,
                _react2.default.createElement(_Nav2.default, { ref: 'top' }),
                _react2.default.createElement(
                    'div',
                ...
                this.state.recipePicked && _react2.default.createElement(_Recipes2.default, { recipes: this.state.recipes, ref: 'recipesList' }),
                this.state.backToTop && _react2.default.createElement(
                    'div',
...
var Recipes = function (_Component) {
    ...
    _createClass(Recipes, [{
        key: "render",
        value: function render() {
            var recipes = this.state.recipes; // array of recipes.
...
var Tween = __webpack_require__(42);
...
var ease = __webpack_require__(46);
