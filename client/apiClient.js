...
// Functions ------------------------------------------------------------------------------------------------
export function getEntreeBy(food, cuisine, diet, intolerances) {
  // getting array of entrees...
  request
    .get(`https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?query=${food}&cuisine=${cuisine}&diet=${diet}&intolerances=${intolerances}&limitLicense=false&type=appetizer&minCalories=700&offset=0&number=100`)
...
export function getMainBy(food, cuisine, diet, intolerances) {
  // getting array of mains...
  request
    .get(`https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/searchComplex?query=${food}&cuisine=${cuisine}&diet=${diet}&intolerances=${intolerances}&limitLicense=false&type=main+course&minCalories=1000&offset=0&number=100`)
